...
function dashboardRouter(path) {
    ...
    const dashboardRoutes = [
        { path: '/dashboard/journal/', template: '/sourceCode/templates/dashboard/journal/journal.html', init: initializeJournalPage },
        { path: "/dashboard/patterns", template: "/sourceCode/templates/dashboard/patterns/patterns.html", init: initializePatternsPage },
        { path: "/dashboard/profile", template: "/sourceCode/templates/dashboard/profile/profile.html", init: initializeProfilePage },
        { path: "/dashboard/surveys", template: "/sourceCode/templates/dashboard/surveys/surveys.html", init: initializeSurveysPage },
        ];

    const matchingRoute = dashboardRoutes.find(route => route.path);
    if (matchingRoute) {
